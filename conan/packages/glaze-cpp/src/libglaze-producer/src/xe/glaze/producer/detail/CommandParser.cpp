...
std::pair<xe::glaze::model::TypeDecl, std::string> parseReturnType(const pugi::xml_node &proto) {
...
xe::glaze::model::CommandParam parseParam(const pugi::xml_node &paramNode) {
    xe::glaze::model::CommandParam param;
...
xe::glaze::model::Command parseCommand(const pugi::xml_node &commandNode,
                                       const std::string &namespaceName) {
    xe::glaze::model::Command command;
...
std::vector<xe::glaze::model::Command> parseCommands(const pugi::xml_node &registry) {
    std::vector<xe::glaze::model::Command> result;
