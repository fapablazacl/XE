...
xe::glaze::model::Enum parseEnum(const pugi::xml_node &enumNode) {
    xe::glaze::model::Enum result;
...
xe::glaze::model::EnumGroup parseEnumGroup(const pugi::xml_node &enumsNode) {
    xe::glaze::model::EnumGroup group;
...
std::vector<xe::glaze::model::EnumGroup> parseEnumGroups(const pugi::xml_node &registry) {
    std::vector<xe::glaze::model::EnumGroup> result;
