...
xe::glaze::model::Remove parseRemove(const pugi::xml_node &removeNode) {
    xe::glaze::model::Remove result;
...
xe::glaze::model::Feature parseFeature(const pugi::xml_node &featureNode) {
    xe::glaze::model::Feature result;
...
std::vector<xe::glaze::model::Feature> parseFeatures(const pugi::xml_node &registry) {
    std::vector<xe::glaze::model::Feature> result;
