...
namespace XE::Graphics::D3D11::TestApp {
    ...
    public:
        ...
        bool Render(ID3D11DeviceContext *context, int unknown, const XE::Math::Matrix4f &world, const XE::Math::Matrix4f &view, const XE::Math::Matrix4f &projection);
    ...
    private:
        ...
        void OutputShaderErrorMessage(ID3D10Blob *blob, HWND hWnd, LPCWSTR msg);
        ...
        void RenderShader(ID3D11DeviceContext *context, int n);
