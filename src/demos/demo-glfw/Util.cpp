...
namespace demo {
    ...
    XE::Subset *createSubset(XE::GraphicsDevice *graphicsDevice, const Mesh &mesh) {
        ...
        const XE::SubsetDescriptor2 subsetDesc{&vertexBuffer, 1, attribs.data(), attribs.size(), indexBuffer};
    ...
    XE::Subset *createCubeSubset2(XE::GraphicsDevice *graphicsDevice, const Mesh &mesh) {
        ...
        const XE::SubsetDescriptor2 subsetDesc{&vertexBuffer, 1, attribs.data(), attribs.size(), nullptr};
