...
namespace XE {
    ...
    GLenum convertToES(const BlendParam param) {
        switch (param) {
        case BlendParam::Zero:
            return GL_ZERO;
        case BlendParam::One:
            return GL_ONE;
        case BlendParam::SourceColor:
            return GL_SRC_COLOR;
        case BlendParam::OneMinusSourceColor:
            return GL_ONE_MINUS_SRC_COLOR;
        case BlendParam::DestinationColor:
            return GL_DST_COLOR;
        case BlendParam::OneMinusDestinationColor:
            return GL_ONE_MINUS_DST_COLOR;
        case BlendParam::SourceAlpha:
            return GL_SRC_ALPHA;
        case BlendParam::OneMinusSourceAlpha:
            return GL_ONE_MINUS_SRC_ALPHA;
        case BlendParam::DestinationAlpha:
            return GL_DST_ALPHA;
        case BlendParam::OneMinusDestinationAlpha:
            return GL_ONE_MINUS_DST_ALPHA;
        case BlendParam::ConstantColor:
            return GL_CONSTANT_COLOR;
        case BlendParam::OneMinusConstantColor:
            return GL_ONE_MINUS_CONSTANT_COLOR;
        case BlendParam::ConstantAlpha:
            return GL_CONSTANT_ALPHA;
        case BlendParam::OneMinusConstantAlpha:
