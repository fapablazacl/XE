...
#include "xe/glaze/GenerateOptions.h"
 ...
 * producer and generators (xe::glaze::producer::ParseError,
...
public:
     ...
     * @throws xe::glaze::producer::ParseError on registry I/O or structural failure
