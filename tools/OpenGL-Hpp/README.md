# OpenGL-hpp
Automatically generates language-specific headers and source files for the OpenGL API from the official Khronos XML spec files, for the different graphics APIs, like:
...
| Use `span` over raw pointer and size parameters | Prevents API misuse |
